...
Organo = {
  \relative c {
    ...
    c(-. c-. g'-. g-.) as!([-. as-. fis8.-.) fis16]-\parenthesize-!
    g8. f16 es8 d16 c g'8(-. g-. g,-. g-.)
    c c g' g, c d \mvTr es[\p-\soloE c] %5
    f es d b es es, es' f
    g es as es g es as g
    f f b, b es es es es
    \mvTr es4\f-\tuttiE b c g'8 g
    as f es c g'4 g, %10
    c8 c g' g, c d \mvTr es[\p-\soloE c]
    f es d b es f g es
    as as as as b b b g
    f es d b es c as b
    ...
    d d c c b[\f a b] c\p \noBreak
    d d d d g,4 r \bar "||"
    \mvTrh es'8\ff-\tuttiE es es es c4 c8 c \noBreak
    b b r b b b b b
    e e e e f f f f %25
...
BassFigures = \figuremode {
  ...
  <_->4 <5 3>8 <7 3> <5 4> <\t 3> r <[7]>
  <6 3> <\t \t> \bo <[7] 3> \bc <[\t] \t> <6 3> <\t \t> <[5] 3> <6>
  <7 3>4 <5 3> r2
  <5 3>4 <[7] 3> <5 3> <5 _!>
  ...
  r2 <5 _!>4. <\t \t>8
  <6 3>4. <\t \t>8 <5 3> <\t \t>4.
  <5 3>2 \bo <5 [4]>4 \bc <\t [3]>8 <[6 5]>
  <5 3>4 <5 _!> q <[7] 3>8 <5 _-> %30
  <6 4>4 <5 4>8 <[\t _!]> <5 3>4 <6- 3>8 <4! 2>
  ...
  r1
  <6! 5 3!>2 \bo <[5!] 4>4 \bc <[\t] _+>
  <_-> <5 _!> q2 %45
  r8 q4. r2
  <7 3>4 <6 [5]> <6 4! 2> <6 3>8 <[7] 3>
  <5 4>4 <\t _!>
  r4.
  <6>4 <_!>8 %50
  <4> <3> r
  ...
  \bo <[9] _!>4 \bc <[8] \t>2. %130
  r8 <\t \t>4. <5 3>4 <6 5>
  <5 3> \bo <[5 3]> \bc <[6 3]> <7 5>
  <5 3>2 \bo <[7 \l]>4. <\t>8
  <6 4>4 \bc <[5 3]> <6 4> <5 _!>
  r2. \bo <[6] 4>8 \bc <[5] _!> %135
  r <5 3> <6 3> <\t \t> r2
  ...
  <6 5 2>4 <6 5 3> r2
  r4 <6 3> <5 3> <5 _!>
  <5 3> q \bo <[9 _!]>8 \bc <[8 \t]>16 <\t \t> <6 3>4
  <6 4> \bo <5 [4]>8 \bc <\t [_!]> r4. <6 5>8
  <5 3>4. <6 5>8 r <6> <7 5 _!>4 %155
  r1
  r8. \bo <[6 4]>16 \bc <[5 3]>8
  r4.
  <6>8 <7 3>4
  <5 3>4. %160
  <5 3>4 <6 3>8
